...
_ALIASES = {
    ...
    "bios details": "BIOS Version",
    "системная плата": "Base Board",
    "базовая плата": "Base Board",
    "процессоры": "Processor",
    "жесткие диски": "Physical Disks",
    "жёсткие диски": "Physical Disks",
    "физические диски": "Physical Disks",
    "сетевые адаптеры": "Network TCP/IP",
    "network adapters": "Network TCP/IP",
    "видеоадаптеры": "Display Adapters",
    "ole db providers": "OLE DB Drivers",
    "автозагрузка программ": "Startup Programs",
    "запланированные задания": "Scheduled Tasks",
    "переменные среды": "Environment Variables",
    "запущенные программы": "Running Programs",
    "память": "Memory",
    "логические диски": "Drives",
    "установленные принтеры": "Installed Printers",
}
